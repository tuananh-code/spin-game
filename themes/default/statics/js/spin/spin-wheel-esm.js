...
var R = Math.pow,
  M = (i, e, t) =>
    e in i
      ? N(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (i[e] = t),
  L = (i, e) => {
...
var B = class {
    ...
    for (let [n, r] of t.entries()) {
      ...
      (e.fillStyle =
        (s = a.backgroundColor) != null
          ? s
          : this._itemBackgroundColors[n % this._itemBackgroundColors.length]),
        e.fill(a.path);
    }
  }
  drawItemImages(e, t = []) {
  ...
  drawItemLabels(e, t = []) {
    ...
    for (let [a, d] of t.entries()) {
      ...
      if (
        (e.translate(
          this._center.x +
            Math.cos(m(_ + -90)) * (this._actualRadius * this.itemLabelRadius),
          this._center.y +
        ...
        this.itemLabelAlign === "left"
          ? (c = this._labelMaxWidth)
          : this.itemLabelAlign === "center" && (c = this._labelMaxWidth / 2),
          e.beginPath(),
          e.moveTo(c, 0),
  ...
  refreshAriaLabel() {
    ...
    this.canvas.setAttribute("alt", "Spin Cheery");
    let e =
      this.items.length >= 2
  ...
  raiseEvent_onCurrentIndexChange(e = {}) {
    ...
    (t = this.onCurrentIndexChange) == null ||
      t.call(
        this,
        L({ type: "currentIndexChange", currentIndex: this._currentIndex }, e)
      );
  }
  raiseEvent_onRest(e = {}) {
    var t;
